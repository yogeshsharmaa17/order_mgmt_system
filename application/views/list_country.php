       ...
       <div class="col-sm-3 col-md-3">
        ...
        <div class="col-sm-6 col-md-6">
            <div class="row">
                ...
                <div class="panel-heading" style="text-align:center;"><strong> <h3>List New Country </h3></strong></div>
            </div>
            </div>
            </div>
 <div class="row">
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
      <div class="panel-body">
        ...
        <form method="post" action="<?=site_url();?>index.php/rcb/list_country_insert" class="form-horizontal" role="form">
           
             <div class="form-group">  
             <div class="col-sm-12" id="notification1"></div>                
                  <div class="col-sm-12">
                    <input type="text" class="form-control" required="" name="country" placeholder="Country Name" />
                  </div>
                </div>
